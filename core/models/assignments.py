...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if auth_principal.principal_id:
            ...
            assertions.assert_valid(assignment.state == AssignmentStateEnum.SUBMITTED or (assignment.state == AssignmentStateEnum.GRADED and principal),
                                    'Only submitted assignments can be graded or graded assignments can be regraded by the principal')
